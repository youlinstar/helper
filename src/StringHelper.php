...
class StringHelper
{
   ...
   * @return string
   */
  public static function strCut(string $string, int $length, string $dot = '...', string $charset = 'utf-8') :string {
   ...
   */
  public static function removeNr(string $str) {
    return preg_replace('/[\r\n]/', '', $str);
  }
   ...
   * @return string
   */
  public static function cutStrUtf8(string $string, int $cutlength, string $dot = '...') :string {
    $returnstr = '';
    $i = 0;
    $n = 0;
    $sourcestr =$string;
